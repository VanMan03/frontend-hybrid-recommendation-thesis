...
export function Destinations() {
  ...
  const { destinations, addDestination, updateDestinationCategory, updateDestination, removeDestination } = useAdminData();
  const [editingDestination, setEditingDestination] = useState<Destination | null>(null);
  const [editingDestinationDetails, setEditingDestinationDetails] = useState<Destination | null>(null);
  ...
  const handleAddDestination = (newDestination: {
    ...
    addDestination({
      ...newDestination,
      entryFee: newDestination.entryFee || '',
      duration: newDestination.duration || '',
      accessibility: newDestination.accessibility || '',
    });
    setIsAddModalOpen(false);
  };

  const handleEditDestinationSave = (destinationId: number, updates: {
    name: string;
    entryFee: string;
    duration: string;
    accessibility: string;
  ...
  return (
    <div className="space-y-6">
                  ...
                  <tr key={dest.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <button 
                                          onClick={() => setEditingDestinationDetails(dest)}
      ...
      {editingDestinationDetails && (
        <EditDestinationModal
          isOpen={!!editingDestinationDetails}
          onClose={() => setEditingDestinationDetails(null)}
          destination={editingDestinationDetails}
